...
class StationsControllerTest < ActionController::TestCase
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post :create, station: { address: @station.address, latitude: @station.latitude, longtitude: @station.longtitude, name: @station.name, route: @station.route }
    end
  ...
  test "should update station" do
    patch :update, id: @station, station: { address: @station.address, latitude: @station.latitude, longtitude: @station.longtitude, name: @station.name, route: @station.route }
    assert_redirected_to station_path(assigns(:station))
  end
